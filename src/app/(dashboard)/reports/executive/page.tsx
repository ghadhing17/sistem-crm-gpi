...
export default function ReportsExecutivePage() {
  return <PlaceholderPage title="Dashboard Eksekutif" desc="Ringkasan bisnis lintas tim: total pendapatan, pipeline, performa cluster, dan leaderboard sales. Khusus Management & Manager. Implementasi di Fase 4." icon="M13 10V3L4 14h7v7l9-11h-7z" />;
}
